  ...
  DocEnvelopeSigner.init(
    {
      ...
      SignatureImageKey: { type: DataTypes.TEXT, allowNull: true },
      InitialsType: { type: DataTypes.STRING, allowNull: true },
      InitialsImageKey: { type: DataTypes.TEXT, allowNull: true },
